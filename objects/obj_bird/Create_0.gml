...
path_add_point(path_bird, branches[0].x + distBetweenEnds / 4, branches[0].y + branchHeightOffset + 100, 100);
path_add_point(path_bird, branches[0].x + distBetweenEnds / 2, branches[0].y + branchHeightOffset + 150, 100);
path_add_point(path_bird, branches[0].x + distBetweenEnds * 3 / 4, branches[0].y + branchHeightOffset + 100, 100);
